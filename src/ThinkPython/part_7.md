...
[![Previous](back.png)](thinkpython2018.html)
...
|                       |    def __str__(self): | tiveASIN=1491907339&l |
...
|                       |         try:          |                       |
|                       |                       |                       |
|                       |  self.suffix_map[self |                       |
|                       | .prefix].append(word) |                       |
|                       |                       |                       |
|                       |      except KeyError: |                       |
|                       |             # if t    |                       |
|                       | here is no entry for  |                       |
|                       | this prefix, make one |                       |
|                       |                       |                       |
|                       |      self.suffix_map[ |                       |
|                       | self.prefix] = [word] |                       |
|                       |                       |                       |
...
|                       | if x > 0:             | &creativeASIN=1491938 |
|                       |     y = math.log(x)   | 455&linkCode=as2&tag= |
|                       | else:                 | greenteapre01-20&link |
|                       |     y = float('nan')  | Id=2JJH4SWCAVVYSQHO){ |
|                       | ```                   | rel="nofollow"}![](ht |
|                       |                       | tp://ir-na.amazon-ads |
...
|                       | which is a special    | =_SL160_&ID=AsinImage |
...
|                       | y = math.log(x) if x  | nteapre01-20&l=as2&o= |
|                       | > 0 else float('nan') | 1&a=1491938455){.c003 |
|                       | ```                   | width="1" height="1"  |
|                       |                       | border="0"}           |
|                       | You can almost read   |                       |
...
|                       | def factorial(n):     | SIN=1491929561&Format |
|                       |     if n == 0:        | =_SL160_&ID=AsinImage |
|                       |         return 1      | &MarketPlace=US&Servi |
|                       |     else:             | ceVersion=20070822&WS |
|                       |         retu          | =1&tag=greenteapre01- |
|                       | rn n * factorial(n-1) | 20){border="0"}](http |
|                       | ```                   | ://www.amazon.com/gp/ |
...
|                       | def factorial(n):     | greenteapre01-20&link |
|                       |                       | Id=PT77ANWARUNNU3UK){ |
|                       | return 1 if n == 0 el | rel="nofollow"}![](ht |
|                       | se n * factorial(n-1) | tp://ir-na.amazon-ads |
|                       | ```                   | ystem.com/e/ir?t=gree |
|                       |                       | nteapre01-20&l=as2&o= |
...
|                       | name, contents=None): |                       |
|                       |                       | [![](http://ws        |
|                       |      self.name = name | -na.amazon-adsystem.c |
|                       |                       | om/widgets/q?_encodin |
|                       |  if contents == None: | g=UTF8&ASIN=144937078 |
|                       |                       | 0&Format=_SL160_&ID=A |
|                       |         contents = [] | sinImage&MarketPlace= |
|                       |         self.pouc     | US&ServiceVersion=200 |
|                       | h_contents = contents | 70822&WS=1&tag=greent |
|                       | ```                   | eapre01-20){border="0 |
|                       |                       | "}](http://www.amazon |
...
|                       |                       | reativeASIN=144937078 |
|                       |   def __init__(self,  | 0&linkCode=as2&tag=gr |
|                       | name, contents=None): | eenteapre01-20)![](ht |
|                       |                       | tp://ir-na.amazon-ads |
|                       |      self.name = name | ystem.com/e/ir?t=gree |
|                       |                       | nteapre01-20&l=as2&o= |
|                       |     self.pouch_conten | 1&a=1449370780){.c003 |
|                       | ts = [] if contents = | width="1" height="1"  |
|                       | = None else contents  | border="0"}           |
|                       | ```                   |                       |
|                       |                       | [Think Python         |
...
|                       | S                     | ts/q?_encoding=UTF8&A |
|                       | ection [10.7](thinkpy | SIN=1491939362&Format |
|                       | thon2011.html#filter) | =_SL160_&ID=AsinImage |
...
|                       |                       | greenteapre01-20&link |
|                       | ``` verbatim          | Id=ZZ454DLQ3IXDHNHX){ |
|                       | d                     | rel="nofollow"}![](ht |
|                       | ef capitalize_all(t): | tp://ir-na.amazon-ads |
|                       |     res = []          | ystem.com/e/ir?t=gree |
|                       |     for s in t:       | nteapre01-20&l=as2&o= |
|                       |         res.a         | 1&a=1491939362){.c003 |
|                       | ppend(s.capitalize()) | width="1" height="1"  |
|                       |     return res        | border="0"}           |
|                       | ```                   |                       |
|                       |                       | [Think Stats          |
|                       | We can write this     | 2e](http://ww         |
|                       | more concisely using  | w.amazon.com/gp/produ |
|                       | a [list               | ct/1491907339/ref=as_ |
...
|                       | ``` verbatim          | WYM6H6YBYUFNWU)![](ht |
|                       | d                     | tp://ir-na.amazon-ads |
|                       | ef capitalize_all(t): | ystem.com/e/ir?t=gree |
|                       |     return [s.cap     | nteapre01-20&l=as2&o= |
|                       | italize() for s in t] | 1&a=1491907339){.c003 |
|                       | ```                   | width="1" height="1"  |
|                       |                       | border="0"}           |
...
|                       | inside the brackets   | _encoding=UTF8&ASIN=1 |
|                       | specifies the         | 491907339&Format=_SL1 |
|                       | elements of the list, | 60_&ID=AsinImage&Mark |
...
|                       | [                     | w.amazon.com/gp/produ |
|                       | ]{#hevea_default1671} | ct/1491907339/ref=as_ |
|                       | [                     | li_tl?ie=UTF8&camp=17 |
...
|                       | ]{#hevea_default1675} |                       |
|                       |                       | [                     |
|                       | ``` verbatim          | ![](http://ws-na.amaz |
|                       | def only_upper(t):    | on-adsystem.com/widge |
|                       |     res = []          | ts/q?_encoding=UTF8&A |
|                       |     for s in t:       | SIN=1449314635&Format |
|                       |                       | =_SL160_&ID=AsinImage |
|                       |       if s.isupper(): | &MarketPlace=US&Servi |
|                       |                       | ceVersion=20070822&WS |
|                       |         res.append(s) | =1&tag=greenteapre01- |
|                       |     return res        | 20){border="0"}](http |
|                       | ```                   | ://www.amazon.com/gp/ |
...
|                       | ``` verbatim          | ag=greenteapre01-20)! |
|                       | def only_upper(t):    | [](http://www.assoc-a |
|                       |     return [s for s   | mazon.com/e/ir?t=gree |
|                       |  in t if s.isupper()] | nteapre01-20&l=as2&o= |
|                       | ```                   | 1&a=1449314635){.c003 |
|                       |                       | width="1" height="1"  |
...
|                       | ids(word, forbidden): |                       |
|                       |     return not a      |                       |
|                       | ny(letter in forbidde |                       |
|                       | n for letter in word) |                       |
|                       | ```                   |                       |
|                       |                       |                       |
|                       | The function almost   |                       |
|                       | reads like English,   |                       |
